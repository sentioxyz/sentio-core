...
func (d *ExtServerDimension) GetSlotHeader(ctx context.Context, sn uint64) (chain.Slot, error) {
	var block api.Block
	err := d.client.UseClient(ctx, "ext.GetSlotHeader", func(ctx context.Context, cli *Client) (r clientpool.Result) {
...
func (d *ExtServerDimension) GetSlot(ctx context.Context, sn uint64) (Slot, error) {
	var block api.Block
	err := d.client.UseClient(ctx, "ext.GetSlot", func(ctx context.Context, cli *Client) (r clientpool.Result) {
