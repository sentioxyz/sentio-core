...
func (s *Argument) UnmarshalJSON(data []byte) error {
	...
	case string:
		...
		return errors.Errorf("invalid Argument: %s", v)
	case map[string]interface{}:
		if v, ok := v["Input"]; ok {
			...
			return errors.Errorf("invalid Argument.Input: %v", v)
		}
		if v, ok := v["Result"]; ok {
			if v, ok := v.(float64); ok {
				t := uint16(v)
			...
			return errors.Errorf("invalid Argument.Result: %v", v)
		}
			...
			if v2, ok := v.([]interface{}); ok {
				...
				for i, v3 := range v2 {
					if v4, ok := v3.(float64); ok {
						...
						return errors.Errorf("invalid Argument.NestedResult: %v", v3)
					}
				}
				s.NestedResult = t
				return nil
			}
			return errors.Errorf("invalid Argument.NestedResult: %v", v)
		}
		return errors.Errorf("invalid Argument: %v", v)
	default:
		return errors.Errorf("invalid Argument: %v", v)
	}
}
...
func (s Argument) MarshalBCS() ([]byte, error) {
	...
	if s.GasCoin != nil {
		...
		return nil, errors.Errorf("invalid Argument: %v", s)
	}
...
func (s *ArgumentsO2M) UnmarshalJSON(data []byte) error {
	...
	if len(j) != 2 {
		return errors.Errorf("invalid ArgumentsO2M: %v", j)
	}
...
func (s *ArgumentsM2O) UnmarshalJSON(data []byte) error {
	...
	if len(j) != 2 {
		return errors.Errorf("invalid ArgumentsM2O: %v", j)
	}
...
func (s *MakeMoveVec) UnmarshalJSON(data []byte) error {
	...
	if len(j) != 2 {
		return errors.Errorf("invalid Publish: %v", j)
	}
...
func (s *Upgrade) UnmarshalJSON(data []byte) error {
	...
	if len(j) != 3 {
		return errors.Errorf("invalid Upgrade: %v", j)
	}
...
func (s MovePackage) MarshalJSON() ([]byte, error) {
	if s.Disassembled == nil {
		return nil, errors.Errorf("disassembled is nil")
	}
...
func (s *MovePackage) UnmarshalJSON(data []byte) error {
	...
	if j.Disassembled == nil {
		return errors.Errorf("unmarshalled disassembled is nil")
	}
...
func (s MovePackage) MarshalBCS() ([]byte, error) {
	if s.ByteCodes == nil {
		return nil, errors.Errorf("bytecodes is nil")
	}
