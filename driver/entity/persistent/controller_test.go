...
type mockChainStore struct {
	...
	// getEntityAfterHook, when set, runs after GetEntity has read its result and before it
	// returns it, outside the store lock; tests use it to hold a read that already has its value.
