  ...
  <div className="p-16 space-y-8">
    ...
    <div className="flex justify-between">
      <DivTooltip text="Left placement" placementOption="left">
        <button className="px-4 py-2 bg-green-500 text-white rounded-sm hover:bg-green-600">
          Left
        </button>
      </DivTooltip>
      <DivTooltip text="Right placement" placementOption="right">
        <button className="px-4 py-2 bg-red-500 text-white rounded-sm hover:bg-red-600">
          Right
        </button>
      </DivTooltip>
    </div>
    <div className="flex justify-center">
      <DivTooltip text="Bottom placement" placementOption="bottom">
        <button className="px-4 py-2 bg-purple-500 text-white rounded-sm hover:bg-purple-600">
          Bottom
        </button>
      </DivTooltip>
    </div>
...
export const CustomStyling = () => (
  <div className="p-8">
    ...
    >
      <button className="px-4 py-2 bg-yellow-500 text-white rounded-sm hover:bg-yellow-600">
        Custom Style
      </button>
    </DivTooltip>
  </div>
